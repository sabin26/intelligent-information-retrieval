...
const TasksCompleteScreen: React.FC<TasksCompleteScreenProps> = ({ onRestart }) => {
  return (
    <motion.div
    ...
    >
      ...
      <h2 className="text-3xl font-bold font-display text-slate-800 tracking-wide z-10 relative mt-4">Tasks Complete</h2>
      <p className="mt-2 text-slate-600 z-10 relative">You have successfully demonstrated both tasks.</p>
