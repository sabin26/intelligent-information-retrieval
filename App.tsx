  ...
  const renderContent = () => {
    switch(appStatus) {
      ...
      case AppStatus.Task1:
        return <Task1_SearchEngine key="task1" onComplete={advanceToTask2} />;
      case AppStatus.Task2:
        return <Task2_DocumentClassifier key="task2" onComplete={finishTasks} />;
      case AppStatus.Complete:
        return <TasksCompleteScreen key="complete" onRestart={restart} />;
      default:
